...
extern int shellHelp(int argc, char *argv[]);
extern int shellUsers(void);
extern int shellCmds(void);
extern int shellVars(void);
extern int shellKeys(void);
extern int shellClear(void);
