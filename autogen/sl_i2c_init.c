...
#include "sl_si91x_i2c_init_i2c1_config.h"
...
sl_i2c_config_t sl_i2c_i2c1_config = {
  .mode = SL_I2C_I2C1_MODE,
  .operating_mode = SL_I2C_I2C1_OPERATING_MODE,
  .transfer_type = SL_I2C_I2C1_TRANSFER_TYPE,
  .i2c_callback = NULL,
};
...
sl_i2c_pin_init_t sl_i2c_i2c1_pin_init = {
  .sda_port = SL_I2C_I2C1_SDA_PORT,
  .sda_pin = SL_I2C_I2C1_SDA_PIN,
  .sda_mux = SL_I2C_I2C1_SDA_MUX,
  .sda_pad = SL_I2C_I2C1_SDA_PAD,
  .scl_port = SL_I2C_I2C1_SCL_PORT,
  .scl_pin = SL_I2C_I2C1_SCL_PIN,
  .scl_mux = SL_I2C_I2C1_SCL_MUX,
  .scl_pad = SL_I2C_I2C1_SCL_PAD,
  .instance = SL_I2C1,
};
...
void sl_i2c_init_instances(void)
{
  ...
  sl_si91x_i2c_pin_init(&sl_i2c_i2c1_pin_init);
