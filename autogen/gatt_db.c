...
{
  0x76, 0xab, 0x5a, 0xa4, 0x13, 0xcc, 0x7a, 0x81, 0x6a, 0x43, 0xaa, 0xa5, 0xe3, 0x2c, 0xab, 0xb6, 
  0x56, 0x55, 0x42, 0xf9, 0x3d, 0x04, 0xd5, 0xaa, 0xf6, 0x4d, 0x79, 0xcd, 0x9d, 0xa6, 0x65, 0x67, 
  0x40, 0x66, 0x82, 0x8a, 0xba, 0x56, 0x66, 0x8b, 0x14, 0x4a, 0xcc, 0xc3, 0x30, 0xdc, 0x7b, 0x20, 
};
...
GATT_DATA(const sli_bt_gattdb_value_t gattdb_attribute_field_18) = {
  .len = 16,
  .data = { 0x02, 0x00, 0x12, 0xac, 0x42, 0x02, 0xa1, 0xaf, 0xed, 0x11, 0xbc, 0xd1, 0x02, 0x4f, 0xc7, 0x00, }
};
...
GATT_DATA(const sli_bt_gattdb_attribute_t gattdb_attributes_map[]) = {
  ...
  { .handle = 0x17, .uuid = 0x8001, .permissions = 0x802, .caps = 0xffff, .state = 0x00, .datatype = 0x01, .dynamicdata = &gattdb_attribute_field_22 },
  { .handle = 0x18, .uuid = 0x0002, .permissions = 0x801, .caps = 0xffff, .state = 0x00, .datatype = 0x05, .characteristic = { .properties = 0x10, .char_uuid = 0x8002 } },
  { .handle = 0x19, .uuid = 0x8002, .permissions = 0x800, .caps = 0xffff, .state = 0x00, .datatype = 0x00, .constdata = &gattdb_attribute_field_24 },
  { .handle = 0x1a, .uuid = 0x000a, .permissions = 0x803, .caps = 0xffff, .state = 0x00, .datatype = 0x03, .configdata = { .flags = 0x01, .clientconfig_index = 0x01 } },
};
