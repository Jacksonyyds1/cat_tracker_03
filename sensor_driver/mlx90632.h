...
#define MLX90632_EEPROM_VERSION     (0x8505)
#define MLX90632_PRODUCT_CODE       (0x0021)
#define NOT_MATCHING_PRODUCT_CODE   (-1)
...
sl_status_t mlx90632_test();

#include "common_i2c.h"

#define MLX90632_I2C_ADD_L  (0x3A)
#define MLX90632_I2C_ADD_H  (0x3B)

#define MLX90632_ADDR       (MLX90632_I2C_ADD_L)    // I2C7位地址，SDO下拉时为0x76，否则为0x77 111011
#define I2C_INSTANCE_USED   INSTANCE_TWO

#define mlx90632_i2c_read(reg_addr, data_p)     \
        platform_read16(I2C_INSTANCE_USED, MLX90632_ADDR, NULL, reg_addr, data_p, 2);

#define mlx90632_i2c_write(reg_addr, data_p)	 \
        platform_write16(I2C_INSTANCE_USED, MLX90632_ADDR, NULL, reg_addr, data_p, 4);

#define mlx90632_i2c_read32(reg_addr, data_p)	 \
        platform_read32(I2C_INSTANCE_USED, MLX90632_ADDR, NULL, reg_addr, (uint32_t *)data_p, 4);

#define msleep(ms)   platform_delay(ms)
